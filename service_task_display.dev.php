          ...
          <div class="card-body">
            <h4 class="card-title">
					...
					&& $Model2->User->Id == $Model2->TaskOwner)
			  {
				  ...
				  <?php
				  $_partialModel = array('uid' =>$_GET["uid"] , 'type'=>$type, 'taskid'=>$Model2->Task->Id, 'DocumentNatures'=>$Model2->DocumentNatures);
				  renderPartialEstado0AutomataSubirArchivos($_partialModel);
			  }
