	...
	$("#jquery_jplayer_1").jPlayer({
		ready: function () {
			$(this).jPlayer("setMedia", {
				...
				m4v: '<?php echo "content/documents/tasks/".$_GET["p1"] . "/" .$_GET["p2"];?>',
				ogv: '<?php echo "content/documents/tasks/".$_GET["p1"] . "/" .$_GET["p2"];?>',
				webmv: '<?php echo "content/documents/tasks/".$_GET["p1"] . "/" .$_GET["p2"];?>',
